<%@page import="com.rays.project3.dto.StudentDTO"%>
<%@page import="java.util.Iterator"%>
<%@page import="com.rays.project3.util.DataUtility"%>
<%@page import="java.util.List"%>
<%@page import="com.rays.project3.util.HTMLUtility"%>
<%@page import="com.rays.project3.util.ServletUtility"%>
<%@page import="com.rays.project3.controller.StudentListCtl"%>
<%@page import="com.rays.project3.dto.CollegeDTO"%>
<%@page import="com.rays.project3.model.ModelFactory"%>
<%@page import="com.rays.project3.model.CollegeModelInt"%>
...
<body class="p4">
	...
	<div>
		<form action="<%=ORSView.STUDENT_LIST_CTL%>" method="post">
			...
			<jsp:useBean id="dto" class="com.rays.project3.dto.StudentDTO"
			...
			<div class="row">
				...
				<%
					if (!ServletUtility.getErrorMessage(request).equals("")&&ServletUtility.getSuccessMessage(request).equals("")) {
				%>
			...
			<div class="row">
				...
				<div class="col-sm-2">
					<input class="form-control" type="text" name="firstName"
						placeholder="Enter First Name" class="p1"
				...
				<div class="col-sm-2"><%=HTMLUtility.getList("college", String.valueOf(dto.getCollegeId()), list1)%></div>
				<div class="col-sm-2">
