...
<body class="p4">
	...
	<div>
		<form action="<%=ORSView.COURSE_LIST_CTL%>" method="post">
			...
			<jsp:useBean id="dto" class="com.rays.project3.dto.CourseDTO"
