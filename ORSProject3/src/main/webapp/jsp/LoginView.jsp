<%@page import="com.rays.project3.controller.UserRegistrationCtl"%>
<%@page import="com.rays.project3.util.ServletUtility"%>
<%@page import="com.rays.project3.controller.LoginCtl"%>
...
.p4 {
	background-image: url('<%=ORSView.APP_CONTEXT%>/img/af.jpg');
	background-size: 100%;
	background-repeat: no repeat;
}
</style>
