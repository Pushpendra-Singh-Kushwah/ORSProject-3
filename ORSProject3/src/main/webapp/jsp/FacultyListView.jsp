<%@page import="com.rays.project3.dto.FacultyDTO"%>
...
<%@page import="com.rays.project3.controller.FacultyListCtl"%>
...
<body class="p4">
	...
	<div>
		<form action="<%=ORSView.FACULTY_LIST_CTL%>" method="post">
			...
			<jsp:useBean id="dto" class="com.rays.project3.dto.FacultyDTO"
