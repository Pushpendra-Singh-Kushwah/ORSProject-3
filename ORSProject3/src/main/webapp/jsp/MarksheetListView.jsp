...
<%@page import="com.rays.project3.dto.MarksheetDTO"%>
<%@page import="java.util.Iterator"%>
<%@page import="java.util.List"%>
<%@page import="com.rays.project3.util.ServletUtility"%>
<%@page import="com.rays.project3.controller.MarksheetListCtl"%>
...
<body class="hm">
	...
	<div>
		<form action="<%=ORSView.MARKSHEET_LIST_CTL%>" method="post">
			...
			<jsp:useBean id="dto" class="com.rays.project3.dto.MarksheetDTO"
			...
			<div class="row">
				...
				<div class=" col-md-4 alert alert-success alert-dismissible">
					<button type="button" class="close" data-dismiss="alert">&times;</button>
					<h4>
						<font color="green"><%=ServletUtility.getSuccessMessage(request)%></font></h4>
				</div>
				<%
					}
				%>
